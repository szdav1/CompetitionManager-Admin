...
public final class NewPouleModal extends AbstractModal {
    ...
    public NewPouleModal() {
        ...
        this.scrollPanel = new ScrollPanel(new Dimension(this.leftPanel.getWidth(), this.leftPanel.getHeight()-(BUTTON_HEIGHT*2)), new FlowLayout(FlowLayout.LEFT, 0, 0), new Appearance(AppearanceRepository.BASE_SCROLL_PANEL_APPEARANCE));
    ...
    public void setUpComponent() {
        ...
        this.scrollPanel.resizeViewPanel(BUTTON_WIDTH+(W_BUTTON_WIDTH*3)+N_BUTTON_WIDTH+4);
