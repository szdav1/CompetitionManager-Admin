...
public final class LogoLabelAppearance extends Appearance {

    public LogoLabelAppearance() {
        this.setBackgroundConfiguration(new BackgroundConfiguration(new SimplePaintConfiguration(CustomColors.OPAQUE)));
        this.setIconSet(new IconSet(Util.loadImageIcon("/assets/appIcon.png", DirectIconSize.sizeByFrame(9, 14))));
    }
