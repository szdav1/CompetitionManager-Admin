...
public final class PoweredByLabelAppearance extends Appearance {

    public PoweredByLabelAppearance() {
        ...
        this.setIconSet(new IconSet(Util.loadImageIcon("/assets/swingIcon.png", DirectIconSize.sizeByFrame(2, 3))));
    }
