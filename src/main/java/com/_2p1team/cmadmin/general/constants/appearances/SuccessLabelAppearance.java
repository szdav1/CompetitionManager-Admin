...
public final class SuccessLabelAppearance extends Appearance {

    public SuccessLabelAppearance() {
        this.setBackgroundConfiguration(new BackgroundConfiguration(new SimplePaintConfiguration(CustomColors.OPAQUE)));
        this.setIconSet(new IconSet(Util.loadImageIcon("/assets/successIcon.png", DirectIconSize.sizeByFrame(6, 9))));
    }
