...
public final class AppearanceRepository {
    public static final Appearance ROOT_PANEL_APPEARANCE = new AppearanceBuilder()
        .setBackgroundConfiguration(new BackgroundConfiguration(new SimplePaintConfiguration(CustomColors.OPAQUE)))
        .build();

    public static final Appearance BACKGROUND_LABEL_APPEARANCE = new AppearanceBuilder()
        .setIconSet(new IconSet(Util.loadImageIcon("/assets/background2.png", SCREEN_WIDTH, SCREEN_HEIGHT)))
        .build();

    public static final Appearance MAIN_PANEL_APPEARANCE = new AppearanceBuilder()
        .setBackgroundConfiguration(new BackgroundConfiguration(new SimplePaintConfiguration(CustomColors.OPAQUE)))
        .build();

    public static final Appearance TITLE_BAR_APPEARANCE = new AppearanceBuilder()
        .setBackgroundConfiguration(new BackgroundConfiguration(new SimplePaintConfiguration(CustomColors.OPAQUE_BLACK)))
        .build();
